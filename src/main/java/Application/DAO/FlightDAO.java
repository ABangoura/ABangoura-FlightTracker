...
public class FlightDAO {
    ...
    public Flight getFlightById(int id){
        ...
        try {
            //Write SQL logic here
            String sql = "SELECT * FROM flight WHERE flight.flight_id = ?";
    ...
    public void updateFlight(int id, Flight flight){
        ...
        try {
            //Write SQL logic here
            String sql = "UPDATE flight SET flight.departure_city = ?, flight.arrival_city = ? WHERE flight.flight_id = ?";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
    ...
    public List<Flight> getAllFlightsFromCityToCity(String departure_city, String arrival_city){
        ...
        try {
            //Write SQL logic here
            String sql = "SELECT * FROM flight WHERE flight.departure_city = ? AND flight.arrival_city = ?";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
